...
async function fetchEvents(month, year) {
  try {
    const response = await axios.get('http://localhost:3000/dividends', {
      params: {
        month: month,
        year: year,
      },
...
onMounted(() => {
  ...
  const currentMonth = currentDate.getMonth() + 1; // JavaScript retorna mês como 0-11
              ...
              <div>
                ...
                <div class="mt-5">
                  ...
                  <div v-if="props.eventDialogData.image != null" class="w-full flex justify-center mt-5">
                    <img :src="props.eventDialogData.image" alt="launch image"
